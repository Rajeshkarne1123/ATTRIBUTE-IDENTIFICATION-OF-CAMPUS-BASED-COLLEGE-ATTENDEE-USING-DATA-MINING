...
<div class="wrapper"> 
  ...
  <div id="topbar">
    ...
    <div id="topnav" style="float:none;">
      <ul>
        ...
        <li class="active"><a href="ViewDataset.jsp">View Dataset</a></li>
 ...
 <ul>
      ...
      <li><a href="AdminHome.jsp">Home</a></li>
  <li>&#187;</li>
      <li  class="current"><a href="ViewDataset.jsp">View Dataset</a></li>
  ...
  <div id="container">
    <div id="content">
      ...
      <centeR>
          ...
          <iframe src="ViewData.jsp" width="800" height="600"/>   
